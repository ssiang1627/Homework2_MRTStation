...
class DualLineViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lineLabel1.text = acceptLineFirstName
        self.lineLabel2.text = acceptLineSecondName
      
       self.lineLabel1.backgroundColor = getLineLabelColor(acceptLineFirstName)
       self.lineLabel2.backgroundColor = getLineLabelColor(acceptLineSecondName)
